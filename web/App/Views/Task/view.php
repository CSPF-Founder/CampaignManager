...
<div class="right_col" role="main">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-8"><?php View::securePrint($task->getHeadline()); ?></div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-4">Summary</div>
                                <div class="col-md-10 col-sm-8 col-xs-8"><?php View::securePrint($task->getSummary()); ?></div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-4 ">Constituency</div>
                                <div class="col-md-10 col-sm-8 col-xs-8"><?php View::securePrint(\App\Models\Constituency::getNameFromId($task->getConstituencyId())); ?></div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-4 ">Responsibility</div>
                                <div class="col-md-10 col-sm-10 col-xs-8"><?php View::securePrint(\App\Models\User::getNameFromId($task->getResponsibility())); ?></div>
                            </div>
                            <div class="row">
    ...
    <?php if(!isset($hide_feedback) || (isset($hide_feedback) && !$hide_feedback)): ?>
        <div class="clearfix"></div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br/>
                        <form action="/task/<?php View::securePrint($task->getId()); ?>/feedback" id="add-entry-form" method="POST" enctype="multipart/form-data" data-parsley-validate
